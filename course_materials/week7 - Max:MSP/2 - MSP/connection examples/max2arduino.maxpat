...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 400.0, 50.0, 213.0, 20.0 ],
					"style" : "",
					"text" : "send multiple messages to an arduino"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 500.0, 25.0, 115.0, 27.0 ],
					"style" : "",
					"text" : "max2arduino"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-71",
					"items" : [ "Bluetooth-Incoming-Port", ",", "Bluetooth-Modem", ",", "blueBeats-SPPDev" ],
					"labelclick" : 1,
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
